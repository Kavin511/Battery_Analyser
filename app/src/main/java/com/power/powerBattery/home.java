...
public class home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        requireContext().registerReceiver(broadcastReceiver,new IntentFilter("BatteryLevelReceiver"));
            View v = (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) ? inflater.inflate(R.layout.fragment_home, container, false) : inflater.inflate(R.layout.home_below_oreo, container, false);
